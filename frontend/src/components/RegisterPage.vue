    ...
    <div class="container-login100">
      <div class="wrap-login100">
        <div class="login100-form validate-form">
          <span class="login100-form-title p-b-43"> ثبت نام کنید </span>
          <div
  ...
  methods: {
    register() {
      fetch("http://localhost:1337/graphql", {
        ...
        body: JSON.stringify({
          query:
            'mutation Register { register(input: {username:"' +
            this.username +
            '", email: "' +
            this.email +
            '", password: "' +
        ...
        .then((r) => r.json())
        .then((data) => localStorage.setItem("jwt", data.data.register.jwt))
